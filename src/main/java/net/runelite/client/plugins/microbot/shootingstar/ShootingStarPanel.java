...
import net.runelite.client.plugins.microbot.shootingstar.model.ShootingStarTableHeader;
import net.runelite.client.plugins.microbot.shootingstar.model.ShootingStarTableRow;
