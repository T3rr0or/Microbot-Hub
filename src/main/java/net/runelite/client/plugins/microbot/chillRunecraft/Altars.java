...
public enum Altars
{
    ...
    NATURE_ALTAR("Nature Altar", ObjectID.NATURE_ALTAR, 34821, 34756 ,new WorldPoint(2872,3015,0), "Nature tiara", "Nature Talisman", "Nature Rune", ItemID.NATURE_TALISMAN),
