...
@ConfigInformation("<html>" + "<h3>TerrorPk Configuration</h3>" + "<p><b>Setup Instructions:</b></p>" + "<ul>" + "<li>Disable anti-ban features in your client for optimal performance.</li>" + "<li>Disable natural mouse movement to ensure precise actions.</li>" + "<li>Enable <b>CAPS LOCK</b> for hotkeys to maintain chat functionality during combat while keeping all keys accessible.</li>" + "</ul>" + "</html>")
@ConfigGroup("terrorpk")
public interface TerrorPkConfig extends Config {
    ...
    @ConfigItem(keyName = "autoPrayAgainstPlayers", name = "Auto-pray vs Players", description = "Automatically toggle protect prayers when attacked by players (detects melee/ranged/magic).", position = 3, section = prayerSection)
