...
public interface AIOCamdozConfig extends Config {
    ...
    default Pickaxes SelectedPickaxe() {
        return Pickaxes.BRONZE;
    }
    ...
    default Nets SelectedNet() {
        return Nets.SMALL_NET;
    }
    ...
    default GolemType SelectedGolemType() {
        return GolemType.FLAWED;
    }
    ...
    default boolean LootOnlyMyDrops() {
        return true;
    }
    ...
    default boolean PickupUntradeables() {
        return true;
    }
