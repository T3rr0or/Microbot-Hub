...
import net.runelite.client.plugins.microbot.amethystminer.enums.AmethystCraftingOption;
import net.runelite.client.plugins.microbot.amethystminer.enums.MiningSpot;
