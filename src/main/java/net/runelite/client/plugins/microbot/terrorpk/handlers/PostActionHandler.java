...
import net.runelite.client.plugins.microbot.terrorpk.actions.MageAction;
import net.runelite.client.plugins.microbot.terrorpk.actions.MeleeAction;
import net.runelite.client.plugins.microbot.terrorpk.actions.RangeAction;
import net.runelite.client.plugins.microbot.terrorpk.actions.SpecAction;

public class PostActionHandler {
    private final TerrorPkConfig config;

    @Inject
    public PostActionHandler(TerrorPkConfig config) {
        this.config = config;
    }
